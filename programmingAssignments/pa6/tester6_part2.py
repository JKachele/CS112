...
class AllTests (unittest.TestCase):
    ...
    def test_check_units_1(self):
        self.assertEqual(check_units('inventory.csv', ['pounds', 'oz']) , 'incorrect units')
    
    def test_check_units_2(self):
        self.assertEqual(check_units('inventory.csv') , 'all fine')
    
    def test_check_units_3(self):
        self.assertEqual(check_units('inventoryA.csv', ['pounds', 'oz']) , 'inventory name incorrect')
    
    def test_check_units_4(self):
        self.assertEqual(check_units('inventoryX.csv') , 'missing units')
    
    ############################################################################
    def test_first_five_ingr_1(self):
        self.assertEqual(first_five_ingr('ingredients.csv', 'chili'), ('kidney beans', 'black beans', 'tomatoes', 'ground turkey', 'chili powder'))
        
    def test_first_five_ingr_2(self):
        self.assertEqual(first_five_ingr('ingredients.csv', 'smoothie'), 'not enough ingredients')
        
    def test_first_five_ingr_3(self):
        self.assertEqual(first_five_ingr('ingredients.csv', 'biryani'), 'recipe not found')
        
    def test_first_five_ingr_4(self):
        self.assertEqual(first_five_ingr('ingredients.csv', 'pizza dough'), ('flour', 'egg', 'water', 'corn meal', 'yeast'))
        
    def test_first_five_ingr_5(self):
        self.assertEqual(first_five_ingr('ingredients.csv', 'ice cream'), 'not enough ingredients')
        
    def test_first_five_ingr_6(self):
        self.assertEqual(first_five_ingr('ingredients.csv', 'meatballs'), ('beef', 'bread crumbs', 'egg', 'milk', 'oregano'))
        
    def test_first_five_ingr_7(self):
        self.assertEqual(first_five_ingr('ingredients.csv', 'omlette'), 'not enough ingredients')
        
    def test_first_five_ingr_8(self):
        self.assertEqual(first_five_ingr('ingredients.csv', 'quesadilla'), ('oil', 'cheddar cheese', 'tortilla', 'black beans', 'tomato'))

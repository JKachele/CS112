...
REQUIRED_DEFNS = [
                    'first_ingredient', 'uses_this', 'in_stock'
                 ]
...
class AllTests (unittest.TestCase):
    ...
    def test_first_ingredient_1(self):
        self.assertEqual(first_ingredient('ingredients.csv', 'pizza dough') , 'flour')
    
    def test_first_ingredient_2(self):
        
        self.assertEqual(first_ingredient('ingredients.csv', 'tiramizu') , 'NOT FOUND')
    
    def test_first_ingredient_3(self):
        
        self.assertEqual(first_ingredient('ingredients.csv', 'meatballs') , 'beef')
    
    def test_first_ingredient_4(self):
        
        self.assertEqual(first_ingredient('ingredients.csv', 'omlette') , 'cheese')
    
    def test_first_ingredient_5(self):
        
        self.assertEqual(first_ingredient('ingredients.csv', 'ice cream') , 'cream')
    
    def test_first_ingredient_6(self):
        
        self.assertEqual(first_ingredient('ingredients.csv', 'smoothie') , 'banana')
    
    def test_first_ingredient_7(self):
        
        self.assertEqual(first_ingredient('ingredients.csv', 'quesadilla') , 'oil')
    
    def test_first_ingredient_8(self):
        
        self.assertEqual(first_ingredient('ingredients.csv', 'chili') , 'kidney beans')

    ############################################################################

    def test_uses_this_1(self):
        res = {'flour': ['pizza dough'], 'egg': ['pizza dough', 'meatballs', 'omlette'], 'yeast': ['pizza dough'], 'oil': ['pizza dough', 'quesadilla'], 'cream': ['ice cream'], 'sugar': ['ice cream'], 'strawberries': ['ice cream'], 'milk': ['ice cream', 'meatballs'], 'banana': ['smoothie'], 'yogurt': ['smoothie'], 'blueberries': ['smoothie'], 'peaches': ['smoothie'], 'beef': ['meatballs'], 'bread crumbs': ['meatballs'], 'oregano': ['meatballs'], 'basil': ['meatballs'], 'salt': ['meatballs'], 'cheese': ['omlette'], 'butter': ['omlette'], 'spinach': ['omlette'], 'tomato': ['quesadilla'], 'kidney beans': ['chili'], 'black beans': ['quesadilla', 'chili'], 'chili powder': ['chili'], 'onion': ['chili'], 'red pepper': ['chili']}
        
        self.assertEqual(uses_this('inventory.csv', 'ingredients.csv'), res)
   


	############################################################################

    def test_in_stock_1(self):
        self.assertEqual(in_stock('inventory.csv', 'ingredients.csv', 'quesadilla'), ['oil->32 oz', 'cheddar cheese->NEED THIS', 'tortilla->NEED THIS', 'black beans->16 oz', 'tomato->8 each'])
    
    def test_in_stock_2(self):
        self.assertEqual(in_stock('inventory.csv', 'ingredients.csv', 'tacos'),['NOT FOUND'])
        
    def test_in_stock_3(self):
        self.assertEqual(in_stock('inventory.csv', 'ingredients.csv', 'smoothie'), ['banana->5 each', 'yogurt->36 oz', 'blueberries->6 oz', 'peaches->3 each'])
    
    def test_in_stock_4(self):
        self.assertEqual(in_stock('inventory.csv', 'ingredients.csv', 'chili'), ['kidney beans->16 oz', 'black beans->16 oz', 'tomatoes->NEED THIS', 'ground turkey->NEED THIS', 'chili powder->2 oz', 'onion->30 oz', 'red pepper->0.5 oz'])

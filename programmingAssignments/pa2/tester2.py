...
REQUIRED_DEFNS = [
                    'to_do', 'priority_level', 'categorize', 'ticket_price'
                 ]
...
class AllTests (unittest.TestCase):
    ...
    '''to_do tests -- x1 pts each == 10 points'''

    def test_to_do_1(self):
        self.assertEqual(to_do(True, True, False), 'Stay inside and watch movies')
    
    def test_to_do_2(self):
        self.assertEqual(to_do(True, False, True), 'Go skiing')
        
    def test_to_do_3(self):
        self.assertEqual(to_do(True, False, False), 'Go for a hike')
        
    def test_to_do_4(self):
        self.assertEqual(to_do(False, True, False), 'Go to the mall')
    
    def test_to_do_5(self):
        self.assertEqual(to_do(False, False, True), 'Stay inside and read a book')
    
    def test_to_do_6(self):
        self.assertEqual(to_do(False, False, False), 'Go to the park')
    
    def test_to_do_7(self):
        self.assertEqual(to_do(True, True, False), 'Stay inside and watch movies')
    
    def test_to_do_8(self):
        self.assertEqual(to_do(False, True, False), 'Go to the mall')
    
    def test_to_do_9(self):
        self.assertEqual(to_do(True, False, True), 'Go skiing')
        
    def test_to_do_10(self):
        self.assertEqual(to_do(False, False, True), 'Stay inside and read a book')
    

    ############################################################################

    '''priority_level tests -- x1 pts each == 10 points'''

    def test_priority_level_1(self):
        self.assertEqual(priority_level(10000.0), 1)
    
    def test_priority_level_2(self):
        self.assertEqual(priority_level(9999.99), 2)
        
    def test_priority_level_3(self):
        self.assertEqual(priority_level(6458.4), 3)
        
    def test_priority_level_4(self):
        self.assertEqual(priority_level(4905.4), 4)
        
    def test_priority_level_5(self):
        self.assertEqual(priority_level(4800.63), 5)
        
    def test_priority_level_6(self):
        self.assertEqual(priority_level(2373.92), 4)
        
    def test_priority_level_7(self):
        self.assertEqual(priority_level(2374.29), 5)
        
    def test_priority_level_8(self):
        self.assertEqual(priority_level(7500.0), 2)
        
    def test_priority_level_9(self):
        self.assertEqual(priority_level(25000.23), 1)
        
    def test_priority_level_10(self):
        self.assertEqual(priority_level(5000.0), 3)
	
	
	############################################################################

    '''categorize tests -- x1 pts each == 10 points'''

    def test_categorize_1(self):
        self.assertEqual(categorize(5.8, 5), 'Low-priced')
    
    def test_categorize_2(self):
        self.assertEqual(categorize(10.0, 10), 'Mid-priced')
        
    def test_categorize_3(self):
        self.assertEqual(categorize(20.01, 25), 'High-priced')
        
    def test_categorize_4(self):
        self.assertEqual(categorize(24.13, 30), 'Premium')
        
    def test_categorize_5(self):
        self.assertEqual(categorize(9.99, 10), 'Other')
        
    def test_categorize_6(self):
        self.assertEqual(categorize(13.65, 20), 'Other')
        
    def test_categorize_7(self):
        self.assertEqual(categorize(20.0, 19), 'Mid-priced')
        
    def test_categorize_8(self):
        self.assertEqual(categorize(37.88, 42), 'Premium')
        
    def test_categorize_9(self):
        self.assertEqual(categorize(83.1, 1), 'High-priced')
        
    def test_categorize_10(self):
        self.assertEqual(categorize(9.9, 9), 'Low-priced')
        
        
    ############################################################################

    '''ticket_price tests -- x1 pts each == 10 points'''
        
    def test_ticket_price_1(self):
        self.assertEqual(ticket_price(9, "Monday"), 4.0)
        
    def test_ticket_price_2(self):
        self.assertEqual(ticket_price(67, "Tuesday"), 5.25)
        
    def test_ticket_price_3(self):
        self.assertEqual(ticket_price(1, "Wednesday"), 4.5)
        
    def test_ticket_price_4(self):
        self.assertEqual(ticket_price(12, "Thursday"), 8.0)
        
    def test_ticket_price_5(self):
        self.assertEqual(ticket_price(10, "Monday"), 6.4)
        
    def test_ticket_price_6(self):
        self.assertEqual(ticket_price(59, "Tuesday"), 10.0)
        
    def test_ticket_price_7(self):
        self.assertEqual(ticket_price(60, "Wednesday"), 7.0)
        
    def test_ticket_price_8(self):
        self.assertEqual(ticket_price(18, "Friday"), 10.0)
        
    def test_ticket_price_9(self):
        self.assertEqual(ticket_price(18, "Monday"), 8.0)
        
    def test_ticket_price_10(self):
        self.assertEqual(ticket_price(7, "Saturday"), 5.0)
